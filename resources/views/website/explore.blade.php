  ...
  <body class="tajawal-bold" style="direction: rtl;">
   ...
   .carousel-control-next-icon {
      ...
      <div class="container">
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-9 text-center mt-5">
            <h1 class="heading tajawal-bold" data-aos="fade-up">استكشف افضل الشاليهات معنا</h1>
            <nav
              ...
              <ol class="breadcrumb text-center justify-content-center py-1">
                ...
                <li
                  class=" active text-white-50" aria-current="page"> / استكشف
                </li>
              </ol>
            </nav>
          </div>
    ...
    <div class="section section-properties"> 
        <div class="container">
            <div class="row justify-content-center align-items-center mb-5 col-lg-2">
                <form method="GET" action="{{ route('explore') }}">
                    @csrf
                    <label class="form-label mb-0 rounded-pill ">الكل</label>
                    <select class="form-select rounded-pill w-10" name="address" onchange="this.form.submit()">
                        <option value="">الكل</option>
                        @foreach ($resorts as $resort)
                            <option value="{{ $resort->address }}" {{ request('address') == $resort->address ? 'selected' : '' }}>
                                {{ $resort->address }}
                            </option>
                        @endforeach
                    </select>
                    <div class="row justify-content-center align-items-center mb-5 rounded-pill">
                        <label class="form-label mb-0">رتب حسب السعر</label>
                        <select class="form-select rounded-pill w" name="price_order" onchange="this.form.submit()">
        ...
        <div class="row align-items-center py-5">
          <div class="col-lg-3">التنقل (1 من 10)</div>
